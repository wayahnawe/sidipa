$(document).ready(function () {
        ...
        columns: [
            ...
            //  { data: "status", name: "status" },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if (row.status != "1") {
                        sev = '<span class="mb-1 badge bg-info">Active</span>';
                    } else {
                        sev = '<span class="mb-1 badge bg-warning">Disable</span>';
                    }
    ...
    deleteData = function (id) {
        toastr.error(
            ...
            "Nama Module akan di hapus dari Module Management?",
            {
                showDuration: "300",
                hideDuration: "1000",
                progressBar: true,
