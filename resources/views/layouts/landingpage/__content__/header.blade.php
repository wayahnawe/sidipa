                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('landingpage/dist/images/demos/demo-dark.jpg') }}"
                                                alt="" class="img-fluid">
                            ...
                            <div class="col-lg-12">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('landingpage/dist/images/apps/app-contact.jpg') }}"
                                                alt="" class="img-fluid">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('landingpage/dist/images/apps/app-invoice.jpg') }}"
                                                alt="" class="img-fluid">
                                                ...
                                                <div class="position-relative">
                                                    <a target="_blank" href="../package/html/main/app-chat.html"
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="{{ asset('landingpage/dist/images/svgs/icon-dd-chat.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                            <h6 class="mb-1 fw-semibold text-hover-primary">Chat
                                                                Application</h6>
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-invoice.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('landingpage/dist/images/svgs/icon-dd-invoice.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                            <h6 class="mb-1 fw-semibold text-hover-primary">Invoice App
                                                            </h6>
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-contact2.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('landingpage/dist/images/svgs/icon-dd-mobile.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                            <h6 class="mb-1 fw-semibold text-hover-primary">Contact
                                                                Application</h6>
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-email.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('landingpage/dist/images/svgs/icon-dd-message-box.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                            <h6 class="mb-1 fw-semibold text-hover-primary">Email App
                                                            </h6>
                                            ...
                                            <div class="col-6">
                                                <div class="position-relative">
                                                    <a target="_blank"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('landingpage/dist/images/svgs/icon-dd-cart.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                            <h6 class="mb-1 fw-semibold text-hover-primary">User
                                                                Profile</h6>
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-calendar.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('landingpage/dist/images/svgs/icon-dd-date.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                            <h6 class="mb-1 fw-semibold text-hover-primary">Calendar
                                                                App</h6>
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-contact.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('landingpage/dist/images/svgs/icon-dd-lifebuoy.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-notes.html"
                                                        class="d-flex align-items-center pb-7 position-relative lh-base">
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('landingpage/dist/images/svgs/icon-dd-application.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                            <h6 class="mb-1 fw-semibold text-hover-primary">Notes
                                                                Application</h6>
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                                                href="../package/html/main/page-pricing.html">Pricing Page</a>
                                        </li>
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                                        ...
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                                                href="../package/html/main/authentication-error.html">404 Error
                                                Page</a>
                                        </li>
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                                        ...
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                                                href="../package/html/main/page-user-profile.html">User Application</a>
                                        </li>
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
