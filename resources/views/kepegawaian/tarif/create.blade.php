...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form id="tblTarif" action="{{ route('backend.tarif.store') }}" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="txtNegara" name="txtNegara" placeholder=""
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="txtLokasi" name="txtLokasi"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="txtUangSaku" name="txtUangSaku"
                                    ...
                                    maxlength="20" class="form-control currency" aria-label=""
                                    placeholder="Contoh: 1,000,000">
                                <span class="input-group-text">,00</span>
                                <input type="text" id="UangSaku" name="UangSaku" hidden>
                            </div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" id="UangHarianGolEselon"
                                                                name="UangHarianGolEselon" hidden>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="accordion-body px-3 fw-normal">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-4 row align-items-left">
                                                    <label for="Hotel1"
                                                        class="form-label fw-semibold col-sm-3 col-form-label text-start">Bintang
                                                        1</label>
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text kurs-text hide"></span>
                                                            <input type="text" id="Hotel1" name="Hotel1"
                                                                ...
                                                                aria-label="" placeholder="Contoh: 1,000,000">
                                                            <span class="input-group-text">,00</span>
                                                            <input type="text" id="txtBintang1" name="txtBintang1"
                                                                hidden>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-4 row align-items-left">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text kurs-text hide"></span>
                                                            <input type="text" id="Hotel2" name="Hotel2"
                                                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                                                maxlength="20" class="form-control currency text-end"
                                                                aria-label="" placeholder="Contoh: 1,000,000">
                                                            <span class="input-group-text">,00</span>
                                                            <input type="text" id="txtBintang2" name="txtBintang2"
                                                                hidden>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" id="Hotel3" name="Hotel3"
                                                                ...
                                                                aria-label="" placeholder="Contoh: 1,000,000">
                                                            <span class="input-group-text">,00</span>
                                                            <input type="text" id="txtBintang3" name="txtBintang3"
                                                                hidden>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-4 row align-items-left">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text kurs-text hide"></span>
                                                            <input type="text" id="Hotel4" name="Hotel4"
                                                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                                                maxlength="20" class="form-control currency text-end"
                                                                aria-label="" placeholder="Contoh: 1,000,000">
                                                            <span class="input-group-text">,00</span>
                                                            <input type="text" id="txtBintang4" name="txtBintang4"
                                                                hidden>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" id="Hotel5" name="Hotel5"
                                                                ...
                                                                aria-label="" placeholder="Contoh: 1,000,000">
                                                            <span class="input-group-text">,00</span>
                                                            <input type="text" id="txtBintang5" name="txtBintang5"
                                                                hidden>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-8 col-xl-9">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input danger" type="radio" name="isdomestik"
                                            id="true" value="domestik" checked>
                                        <label class="form-check-label" for="" >Dalam Negeri</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input danger" type="radio" name="isdomestik"
                                            id="false" value="internasional">
                    ...
                    <div class="d-md-flex align-items-center mt-3">
                        <div class="ms-auto mt-3 mt-md-0">
                            ...
                            <a type="button" class="btn btn-danger font-medium rounded-pill px-4"
                                href="{{ route('backend.tarif.index') }}">
                                <div class="d-flex align-items-center">
