...
@section('content')
    <div class="card">
        <div class="card-body">
            <form id="frmInput" class="mt-4" action="{{ route('backend.employee.update',$employees->id) }}" method="POST" enctype="multipart/form-data">
                {{method_field('PUT')}}
                        ...
                        <div class="card-body p-4">
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade active show" id="pills-personal-info" role="tabpanel"
                                    ...
                                    <div class="row">
                                        @include('kepegawaian.kepegawaian.__ edit__.data_pegawai')
...
@push('scripts')
<script src="{{ asset('bootstrap/dist/js/dipa/dipa-employee-update.js') }}"></script>
