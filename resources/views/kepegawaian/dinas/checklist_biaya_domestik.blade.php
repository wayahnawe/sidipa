                        ...
                        <div class="card-body p-4">
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade" id="pills-personal-info" role="tabpanel"
                                    ...
                                    @include('kepegawaian.dinas.__domestik__.read_surat_tugas')
                                </div>
                                <div class="tab-pane fade active show" id="pills-account-details" role="tabpanel"
                            ...
                            <div class="card">
                                <ul class="nav nav-pills user-profile-tab border-bottom" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6 fw-bold active"
                                            id="pills-detail-checklist-biaya-info-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-detail-checklist-biaya-info" type="button"
                                            role="tab" aria-controls="pills-detail-checklist-biaya-info"
                                            aria-selected="true">
                                ...
                                <div class="card-body p-4">
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade active show" id="pills-personal-info" role="tabpanel"
                                            aria-labelledby="pills-detail-checklist-biaya-info-tab" tabindex="0">
                                            @include('kepegawaian.dinas.__domestik__.check_list_peserta')
                                        </div>
                                        {{-- <div class="tab-pane fade active show" id="pills-account-details" role="tabpanel"
                                            aria-labelledby="pills-account-details-tab" tabindex="0">
                                            @include('kepegawaian.dinas.__domestik__.check_list')
...
@push('scripts')
    ...
    <script src="{{ asset('bootstrap/dist/js/dipa/dipa_spd_checklist.js') }}"></script>
